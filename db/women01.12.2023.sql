--
-- Файл сгенерирован с помощью SQLiteStudio v3.4.4 в Пт дек 1 06:15:16 2023
--
...
INSERT INTO auth_permission (id, content_type_id, codename, name) VALUES (37, 10, 'add_husband', 'Can add husband');
INSERT INTO auth_permission (id, content_type_id, codename, name) VALUES (38, 10, 'change_husband', 'Can change husband');
INSERT INTO auth_permission (id, content_type_id, codename, name) VALUES (39, 10, 'delete_husband', 'Can delete husband');
INSERT INTO auth_permission (id, content_type_id, codename, name) VALUES (40, 10, 'view_husband', 'Can view husband');
...
INSERT INTO django_content_type (id, app_label, model) VALUES (10, 'women', 'husband');
...
INSERT INTO django_migrations (id, app, name, applied) VALUES (25, 'women', '0007_husband_women_husband', '2023-11-27 16:25:43.158593');
INSERT INTO django_migrations (id, app, name, applied) VALUES (26, 'women', '0008_alter_women_cat', '2023-11-28 17:17:48.027596');
...
-- Таблица: women_husband
CREATE TABLE IF NOT EXISTS "women_husband" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "name" varchar(100) NOT NULL, "age" integer NULL);
INSERT INTO women_husband (id, name, age) VALUES (1, 'Брэд Питт', 59);
INSERT INTO women_husband (id, name, age) VALUES (2, 'Том Акерли', 31);
INSERT INTO women_husband (id, name, age) VALUES (3, 'Дэниэл Модер', NULL);
INSERT INTO women_husband (id, name, age) VALUES (4, 'Кук Марони', NULL);
...
-- Таблица: women_women
CREATE TABLE IF NOT EXISTS "women_women" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "title" varchar(255) NOT NULL, "content" text NOT NULL, "time_create" datetime NOT NULL, "time_update" datetime NOT NULL, "is_published" bool NOT NULL, "slug" varchar(255) NOT NULL UNIQUE, "cat_id" bigint NOT NULL REFERENCES "women_category" ("id") DEFERRABLE INITIALLY DEFERRED, "husband_id" bigint NULL UNIQUE REFERENCES "women_husband" ("id") DEFERRABLE INITIALLY DEFERRED);
INSERT INTO women_women (id, title, content, time_create, time_update, is_published, slug, cat_id, husband_id) VALUES (1, 'Анжелина Джоли', 'Анджелина Джоли (англ. Angelina Jolie[7], при рождении Войт (англ. Voight), ранее Джоли Питт (англ. Jolie Pitt); род. 4 июня 1975, Лос-Анджелес, Калифорния, США) — американская актриса кино, телевидения и озвучивания, кинорежиссёр, сценаристка, продюсер, фотомодель, посол доброй воли ООН.
...
', '2023-10-25 16:55:15.128045', '2023-10-25 16:55:15.128045', 1, 'djuliya-roberts', 2, NULL);
INSERT INTO women_women (id, title, content, time_create, time_update, is_published, slug, cat_id, husband_id) VALUES (4, 'Екатерина Гусева', 'Родилась 9 июля 1976 года в городе Москве.
...
INSERT INTO women_women (id, title, content, time_create, time_update, is_published, slug, cat_id, husband_id) VALUES (5, 'Ариана Гранде', 'Ариана Гранде-Бутера[3] (англ. Ariana Grande-Butera; род. 26 июня 1993, Бока-Ратон, Флорида)  американская певица, актриса, автор песен, музыкальный продюсер[4][5], обладательница премии Грэмми[6].
